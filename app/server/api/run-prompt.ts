...
export default defineEventHandler(async (event) => {
  ...
  const result = await generateText({
    ...
    system: `
# Role
You are a backend JavaScript developer with deep knowledge of REST APIs and web services.
Your job is to help write the JavaScript statements necessary to help the user make the API call.
...
Your last statement should always \`return\` a value.
`,
  });
